...
def mergeCache_add(mergeCache, a,b,merged):
    Trace.writej(lambda:[ 'ENTER mergeCache_add',
    ...
    Trace.writej(lambda:[ 'EXIT mergeCache_add',
                             mergeCache_asdict(mergeCache),
                            ])

def merge(a:PredictionContext, b:PredictionContext, rootIsWildcard:bool, mergeCache:dict):
    Trace.writej(lambda:[ 'ENTER PredictionContext.merge',
                             a.asdict(),
                             b.asdict(),
                             rootIsWildcard,
    ...
    Trace.writej(lambda:[ 'EXIT PredictionContext.merge',
                             rv.asdict()
                            ])
    return rv
...
def mergeSingletons(a:SingletonPredictionContext, b:SingletonPredictionContext, rootIsWildcard:bool, mergeCache:dict):
    Trace.writej(lambda:[ 'ENTER PredictionContext.mergeSingletons',
                             a.asdict(),
                             b.asdict(),
                             rootIsWildcard,
                             (None if mergeCache is None else mergeCache_asdict(mergeCache))
    ...
    Trace.writej(lambda:[ 'EXIT PredictionContext.mergeSingletons',
                             rv.asdict(),
                             (None if mergeCache is None else mergeCache_asdict(mergeCache))
                            ])
    return rv
...
def mergeRoot(a:SingletonPredictionContext, b:SingletonPredictionContext, rootIsWildcard:bool):
    Trace.writej(lambda:[ 'ENTER PredictionContext.mergeRoot',
                             a.asdict(),
                             b.asdict(),
                             rootIsWildcard
                            ])
    rv = _mergeRoot(a, b, rootIsWildcard)
    Trace.writej(lambda:[ 'EXIT PredictionContext.mergeRoot',
...
def mergeArrays(a:ArrayPredictionContext, b:ArrayPredictionContext, rootIsWildcard:bool, mergeCache:dict):
    Trace.writej(lambda:[ 'ENTER PredictionContext.mergeArrays',
                             a.asdict(),
                             b.asdict(),
                             rootIsWildcard,
                             (None if mergeCache is None else mergeCache_asdict(mergeCache))
    ...
    Trace.writej(lambda:[ 'EXIT PredictionContext.mergeArrays',
                             rv.asdict()
                            ])
    return rv
